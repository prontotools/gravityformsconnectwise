...
require_once WP_PLUGIN_DIR . '/connectwise-forms-integration/class-gf-connectwise-2018v6.php';
require_once 'vendor/autoload.php';

class GravityFormsConnectWiseAddOnTest2018V4 extends WP_UnitTestCase {
	function setUp() {
		parent::setUp();

		$this->connectwise_plugin = new GFConnectWise2018V6();
	...
	function test_member_api_should_return_correct_member_list() {
		$GF_ConnectWise = $this->getMockBuilder( 'GFConnectWise2018v6' )
